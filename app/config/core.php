<?php
// for production changes, search by :production
 ...
 */
	Configure::write('Security.salt', 'trytoimagineyourselfinthecretaceousperiodyougetyourfirstlookatthissixfootturkeyasyouenteraclearing');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '845425454654654664351415646545665445465499599999999991');
 ...
 */
	//Configure::write('Asset.filter.css', 'css.php'); //uncomment for :production
